...
codings_wide = 
  ...
  # unlist factor categories
  mutate_at(vars(-aftermath, -process), unlist) %>%
  # substitute NULLs for empty vectors with functional magic
...
> TODO: mark placement of codes withing stories in dataset

Centering stories around the instance or pattern of unauthorized access, the categories can be seen as reflecting three periods in time: *before*, *during*, and *after*.
